...
test('Reminders, Doc Expirations, Tires, and Vehicle cards render at the top in order', async ({ page }) => {
  ...
  expect(cards[2]).toMatch(/Tires|Llantas/);
  expect(cards[3]).toMatch(/Vehicle|Vehículo/);
});
